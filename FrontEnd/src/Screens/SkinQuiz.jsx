...
const styles = StyleSheet.create({
  ...
  question: { color: '#F49CA5', marginBottom: 5, fontFamily: 'Poppins-SemiBold' },
  title: { fontSize: 18, fontFamily: 'Poppins-Bold', marginBottom: 5, color: '#da8f8fff' },
  ...
  optionDesc: { color: '#4b4b4bff', fontSize: 12 , fontFamily: 'Poppins-Regular'},
  bottomButtons: {
    flexDirection: 'row',
